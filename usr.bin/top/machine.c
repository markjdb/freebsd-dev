...
int memory_stats[8];
char *memorynames[] = {
	"K Active, ", "K Inact, ", "K Noreuse, ", "K Wired, ", "K Cache, ", "K Buf, ",
	"K Free", NULL
};
...
get_system_info(struct system_info *si)
{
	...
	/* sum memory & swap statistics */
	{
		...
		GETSYSCTL("vm.stats.vm.v_noreuse_count", memory_stats[2]);
		GETSYSCTL("vm.stats.vm.v_wire_count", memory_stats[3]);
		GETSYSCTL("vm.stats.vm.v_cache_count", memory_stats[4]);
